      ...
      <div style={{padding:"6px 12px",borderRadius:8,background:"rgba(34,197,94,0.1)",border:"1px solid rgba(34,197,94,0.3)",color:"#16a34a",fontWeight:700,minWidth:120,textAlign:"center"}}>
        ...
        {section === "ai-studio" && (
          <div>
            ...
            {[
              {step:1,title:"Purchase & Download",color:"#7c3aed",desc:"Purchase AI Studio license at axto.io. Your license key starts with AIST-. Download the package from Portal → Licenses → Download.",code:`# Docker Image\ndocker load < axto-ai-studio-2.0.0.tar.gz\n\n# Windows EXE\n./axto-ai-studio.exe  # Auto-opens browser at localhost:8091`},
        ...
        {section === "gpu-studio" && (
          <div>
            ...
            {[
              {step:1,title:"Purchase & Download",color:"#d97706",desc:"Purchase GPU Studio license at axto.io. Your license key starts with GPUS-. Download from Portal → Licenses → Download.",code:`# Docker Image\ndocker load < axto-gpu-studio-2.0.0.tar.gz\n\n# Windows EXE  \n./axto-gpu-studio.exe  # Opens browser at localhost:8092`},
