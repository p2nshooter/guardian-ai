...
const TRANSLATIONS: Record<string, Partial<Record<Locale, string>>> = {
  ...
  "landing.faq.a6": { en:"Products continue in read-only mode for a 7-day grace period. Automated renewal reminders sent at 30, 14, and 3 days before expiry.", id:"Produk tetap berjalan dalam mode read-only selama masa tenggang 7 hari. Pengingat perpanjangan otomatis dikirim 30, 14, dan 3 hari sebelum kedaluwarsa." },
  ...
  "landing.delivery.title2": { en:"Docker Image + Windows EXE", id:"Docker Image + Windows EXE" },
  ...
  "landing.delivery.c2t": { en:"Windows EXE (Portable)", id:"Windows EXE (Portable)" },
  "landing.delivery.c2d": { en:"Single-file PyInstaller executable. No Python installation required. Double-click to run. Ideal for Windows Server environments, air-gapped networks, and quick evaluation.", id:"Executable satu-file dari PyInstaller. Tidak perlu instalasi Python. Cukup klik dua kali untuk menjalankan. Ideal untuk lingkungan Windows Server, jaringan air-gapped, dan evaluasi cepat." },
