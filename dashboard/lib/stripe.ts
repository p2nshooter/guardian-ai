...
export const PACKAGE_INFO: Record<string, PackageInfo> = {
  ...
  vault_starter: {
    ...
    price: 4990, priceMonthly: 499,
    product: "vault", maxRequests: 50_000, maxScansPerDay: 50_000, forSale: false,
  ...
  vault_professional: {
    ...
    product: "vault", maxRequests: 500_000, maxScansPerDay: 500_000, forSale: false,
  ...
  vault_business: {
    ...
    product: "vault", maxRequests: 5_000_000, maxScansPerDay: 5_000_000, forSale: false,
  ...
  vault_enterprise: {
    ...
    product: "vault", maxRequests: -1, maxScansPerDay: -1, forSale: false,
  ...
  edge_starter: {
    ...
    product: "edge", maxRequests: 100_000, forSale: false,
  ...
  edge_professional: {
    ...
    product: "edge", maxRequests: 1_000_000, forSale: false,
  ...
  edge_business: {
    ...
    product: "edge", maxRequests: 10_000_000, forSale: false,
  ...
  edge_enterprise: {
    ...
    product: "edge", maxRequests: -1, forSale: false,
  ...
  // ── AXTO SOC — AI Security Operations Center ───────────────────────────────
    ...
    price: 24900, priceMonthly: 2490,
    product: "soc", maxNodes: 5, maxEPS: 200, forSale: false,
  ...
  soc_professional: {
    ...
    price: 79000, priceMonthly: 7900,
    product: "soc", maxNodes: 25, maxEPS: 1000, forSale: false,
  ...
  soc_business: {
    ...
    product: "soc", maxNodes: 100, maxEPS: 10000, forSale: false,
  ...
  soc_enterprise: {
    ...
    price: 249000, priceMonthly: 24900,
    product: "soc", maxNodes: -1, maxEPS: -1, forSale: false,
  ...
  compliance_starter: {
    ...
    price: 7990, priceMonthly: 799,
    product: "compliance", forSale: false,
  ...
  sentinel_starter: {
    ...
    product: "sentinel", maxDevices: 50, maxNodes: 50, forSale: false,
  ...
  sentinel_professional: {
    ...
    price: 39900, priceMonthly: 3990,
    product: "sentinel", maxDevices: 500, maxNodes: 500, forSale: false,
  ...
  sentinel_business: {
    ...
    product: "sentinel", maxDevices: 5000, maxNodes: 5000, forSale: false,
  ...
  sentinel_enterprise: {
    ...
    product: "sentinel", maxDevices: -1, maxNodes: -1, forSale: false,
  ...
  privacy_suite: {
    ...
    product: "vault", isBundle: true, forSale: false,
  ...
  security_suite: {
    ...
    product: "soc", isBundle: true, forSale: false,
