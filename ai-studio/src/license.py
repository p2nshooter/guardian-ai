...
PRODUCT          = "ai-studio"          # this app's own identity (cache file, logs)
STUDIO_MODULE    = "ai"                 # this app's entry in STUDIO_PLANS[].studios (lib/studio.ts)
    ...
    async with _lock:
        ...
        if not _state.key.startswith(PRODUCT_PREFIX + "-"):
            ...
            _state.error = (
                ...
                f"— this is your AXTO Studio license (AI Studio is one of the "
                f"sub-apps it unlocks, alongside GPU Studio and Hybrid Studio)."
            )
        ...
        try:
            ...
            if resp.status_code == 200 and data.get("valid"):
                ...
                if STUDIO_MODULE not in studios:
                    _state.valid = False
                    _state.error = (
                        "Your AXTO Studio plan does not include AI Studio. "
