...
def generate_pdf_report(
    ...
    try:
        ...
        story.append(Paragraph(
            ...
            "Copyright © 2024-2026 Axto AI. All rights reserved. AXTO® (axto.io).",
            small
        ))
        ...
        lines = [
            ...
            f"Copyright (c) 2024-2026 Axto AI. axto.io",
            f"{'='*60}",
            f"Title: {title}",
            f"Document: {doc_meta.get('filename', '')}",
...
def generate_docx_report(title: str, analysis: dict, doc_meta: dict) -> bytes:
    ...
    try:
        ...
        run = meta_p.add_run(
            ...
            f"Document: {doc_meta.get('filename', '')} | "
            f"Generated: {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}\n"
            f"Copyright © 2024-2026 Axto AI | axto.io"
        )
        run.font.size = Pt(9)
        ...
        disclaimer = doc.add_paragraph(
            ...
            "Copyright © 2024-2026 Axto AI. AXTO® (axto.io)"
        )
